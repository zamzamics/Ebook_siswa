...
class BahasaArab extends StatefulWidget {
  const BahasaArab({super.key});

  @override
  State<BahasaArab> createState() => _BahasaArabState();
}

class _BahasaArabState extends State<BahasaArab> {
  final PdfViewerController _pdfViewerController = PdfViewerController();
  final String eBooks = "bahasa arab.pdf";
